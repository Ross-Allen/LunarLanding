#ifndef _LUNAR_LANDER_HPP
#define _LUNAR_LANDER_HPP
#define PI 3.14159
...
private:
  Vect gravity;                // 1.622 m/s^2 on the moon
  ...
  double maxTouchdownSpeed;    // do not exceed at landing
  bool crashed;                // becomes true if position.y <=0 and absolute velocity.y
  // is greater than maxTouchdownVelocity or angle is not 90
